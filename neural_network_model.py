# =============================================================
# Part A: Neural Network Model - Individual Practical Assessment
...
# ---------------------------
print("=" * 55)
print("  Neural Network Classifier - Iris Dataset")
print("=" * 55)
...
# ---------------------------
# 4. Build & Train Neural Network
# ---------------------------
print("\n[INFO] Training Neural Network (MLP)...")
print("       Architecture: Input(4) -> Dense(64) -> Dense(32) -> Output(3)")
